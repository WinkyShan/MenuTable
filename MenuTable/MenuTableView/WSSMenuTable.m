...
-(UITableViewCell * )tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.singleDataArray.count > indexPath.row) {
        ...
        if ([self.delegate respondsToSelector:@selector(showRowDataWithView:AtIndex:)]) {
            cell.contentLbl.text =  [self.delegate showRowDataWithView:self AtIndex:indexPath];
        }
    }
    ...
    if (indexPath.row == titleSelectRow) {
        cell.contentLbl.textColor = [UIColor redColor];
